...
[![Release](https://img.shields.io/badge/release-v1.4.8-blue)](https://github.com/kabzon93region/Quest-Task-Manager/releases/tag/v1.4.8)
[![Download APK](https://img.shields.io/badge/download-APK-brightgreen)](https://github.com/kabzon93region/Quest-Task-Manager/releases/download/v1.4.8/QTaskMgr-v1.4.8-release.apk)
...
| **Версия** | 1.4.8 ([схема версий](docs/VERSIONING.md)) |
...
| Вкладка | Описание |
|---------|----------|
| **Запущенные** | Процессы (ps + uid/proc + activity), RAM устройства и на карточке, VR-игры под оверлеем Quest, фильтры Все / Пользовательские / Системные / **Демоны**, **поиск**, закрытие (все / выбранные / по правилам) |
...
1. Скачайте APK из [Releases](https://github.com/kabzon93region/Quest-Task-Manager/releases) или [напрямую v1.4.8](https://github.com/kabzon93region/Quest-Task-Manager/releases/download/v1.4.8/QTaskMgr-v1.4.8-release.apk); либо соберите сами.
...
```powershell
adb install -r dist\QTaskMgr-v1.4.8-release.apk
```
...
│   ├── GITHUB_PUBLISH.md
│   ├── VERSIONING.md
│   ├── RELEASE_NOTES_v1.4.8.md   # актуальный для GitHub Releases
